...
ggplot() +
  ...
  geom_point( data=data_geo_country, aes(x=long, y=lat, size=count_specimens, fill=count_specimens, alpha = count_specimens), shape = 21, stroke = 2, color ="white")+
  scale_size_continuous(name="Number of Specimens", trans="log", range=c(3,10), breaks=mybreaks) +
    ...
    scale_fill_distiller(palette = "YlOrBr", trans="log", breaks=mybreaks,name="Number of Specimens") +
  theme_void() +
...
ggsave("map1.png", width = 16, height = 8.5, units = "in")
...
```
Nanodrop data won't be included in the poster. 
...
Shows that there is weak correlation between Nanodrop concentration and Qubit concentration
